 ...
 */
final class Version20240819084313 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE code_nomenclature ADD CONSTRAINT FK_CODE_STR FOREIGN KEY (code_str) REFERENCES str_nome (code_str) ON DELETE CASCADE');
    }
}
