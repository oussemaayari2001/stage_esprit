 ...
 */
final class Version20240819084217 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE code_nomenclature DROP FOREIGN KEY code_str');
        ...
        $this->addSql('ALTER TABLE code_nomenclature ADD PRIMARY KEY (code_nome)');
        $this->addSql('DROP INDEX code_str ON code_nomenclature');
        $this->addSql('CREATE INDEX IDX_B2B2C437B48E9453 ON code_nomenclature (code_str)');
        $this->addSql('ALTER TABLE code_nomenclature ADD CONSTRAINT code_str FOREIGN KEY (code_str) REFERENCES str_nome (code_str) ON UPDATE CASCADE ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE code_nomenclature ADD CONSTRAINT code_str FOREIGN KEY (code_str) REFERENCES str_nome (code_str) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE code_nomenclature ADD PRIMARY KEY (code_nome, code_str)');
        $this->addSql('DROP INDEX idx_b2b2c437b48e9453 ON code_nomenclature');
        $this->addSql('CREATE INDEX code_str ON code_nomenclature (code_str)');
        $this->addSql('ALTER TABLE code_nomenclature ADD CONSTRAINT FK_B2B2C437B48E9453 FOREIGN KEY (code_str) REFERENCES str_nome (code_str) ON DELETE CASCADE');
