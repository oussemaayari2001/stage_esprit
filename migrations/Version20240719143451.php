 ...
 */
final class Version20240719143451 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE classe (code_cl VARCHAR(10) NOT NULL, libelle_cl VARCHAR(60) NOT NULL, description_cl VARCHAR(300) NOT NULL, date_cr DATE NOT NULL, date_dern_modif DATE NOT NULL, salle_principale VARCHAR(3) NOT NULL, salle_secondaire_1 VARCHAR(3) NOT NULL, salle_secondaire_2 VARCHAR(3) NOT NULL, niveau_accees INT NOT NULL, filiere VARCHAR(2) NOT NULL, annee_scolaire VARCHAR(4) NOT NULL, PRIMARY KEY(code_cl)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE compteur (code_cpt VARCHAR(2) NOT NULL, lib_cpt VARCHAR(20) NOT NULL, date_cr DATE NOT NULL, date_last_modif DATE NOT NULL, taille INT NOT NULL, valeur INT NOT NULL, PRIMARY KEY(code_cpt)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE esp_plan_etude (code_module VARCHAR(10) NOT NULL, num_panier VARCHAR(5) NOT NULL, code_cl VARCHAR(10) NOT NULL, annee_deb VARCHAR(4) NOT NULL, annee_fin VARCHAR(4) NOT NULL, description VARCHAR(500) NOT NULL, nb_heures INT NOT NULL, coef INT NOT NULL, num_semestre INT NOT NULL, num_periodfe INT NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, date_examen DATE NOT NULL, date_rattrapage DATE NOT NULL, nb_horaire_realises INT NOT NULL, acomptabiliser INT NOT NULL, id_ens VARCHAR(10) NOT NULL, esp_annee_deb VARCHAR(10) NOT NULL, code_salle VARCHAR(3) NOT NULL, id_ens2 VARCHAR(10) NOT NULL, nb_heures_ens INT NOT NULL, nb_heures_ens2 INT NOT NULL, PRIMARY KEY(code_module)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE esp_saison_classe (code_cl VARCHAR(255) NOT NULL, annee_deb VARCHAR(10) NOT NULL, date_demarrage DATE NOT NULL, description VARCHAR(300) NOT NULL, nb_etudiant INT NOT NULL, salle_principale VARCHAR(2) NOT NULL, salle_secondaire_1 VARCHAR(3) NOT NULL, salle_secondaire_2 VARCHAR(3) NOT NULL, nature VARCHAR(1) NOT NULL, type_classe VARCHAR(2) NOT NULL, nb_seance INT NOT NULL, classe_entreprise VARCHAR(1) NOT NULL, semestre INT NOT NULL, cl_eclate VARCHAR(1) NOT NULL, PRIMARY KEY(code_cl)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE esp_saison_universitaire (annee_deb VARCHAR(255) NOT NULL, description VARCHAR(100) NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, observation VARCHAR(500) NOT NULL, PRIMARY KEY(annee_deb)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE photos_etudiant (id_et VARCHAR(10) NOT NULL, photos_id LONGBLOB NOT NULL, PRIMARY KEY(id_et)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
